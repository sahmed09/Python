...
sqlstr = 'SELECT Track.title, Artist.name, Album.title, Genre.name FROM Track JOIN Genre JOIN Album ' \
         'JOIN Artist ON Track.genre_id = Genre.ID and Track.album_id = Album.id AND ' \
