...
while True:
    address = input('Enter location: ')  # input: Ann Arbor, MI or any other location
    if len(address) < 1:
        break
...
address = input('Enter location: ')  # input: South Federal University or any other location
